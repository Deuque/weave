      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            ...
            children: [
              FlatButton(onPressed: ()=>Navigator.pop(context,false), child: Text('cancel',style: TextStyle(color: error),)),
              FlatButton(onPressed: ()=>Navigator.pop(context,true), child: Text('restart',style: TextStyle(color: success),))
            ],
